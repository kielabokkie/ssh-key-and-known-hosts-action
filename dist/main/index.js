...
const crossSpawn = __nccwpck_require__(5237);
const stripFinalNewline = __nccwpck_require__(2070);
const npmRunPath = __nccwpck_require__(6404);
const onetime = __nccwpck_require__(2927);
const makeError = __nccwpck_require__(1906);
const normalizeStdio = __nccwpck_require__(9550);
const {spawnedKill, spawnedCancel, setupTimeout, setExitHandler} = __nccwpck_require__(9483);
const {handleInput, getSpawnedResult, makeAllStream, validateInputSync} = __nccwpck_require__(9317);
const {mergePromise, getSpawnedPromise} = __nccwpck_require__(6888);
const {joinCommand, parseCommand} = __nccwpck_require__(8283);
...
const {signalsByName} = __nccwpck_require__(7734);
...
const onExit = __nccwpck_require__(6375);
...
const isStream = __nccwpck_require__(3921);
const getStream = __nccwpck_require__(3274);
const mergeStream = __nccwpck_require__(5759);
...
const parse = __nccwpck_require__(3803);
const enoent = __nccwpck_require__(5855);
...
const path = __nccwpck_require__(1017);
const resolveCommand = __nccwpck_require__(6298);
const escape = __nccwpck_require__(7580);
const readShebang = __nccwpck_require__(5490);
...
const shebangCommand = __nccwpck_require__(9200);
...
const path = __nccwpck_require__(1017);
const which = __nccwpck_require__(4989);
const getPathKey = __nccwpck_require__(8123);
...
const shebangRegex = __nccwpck_require__(3541);
...
const pump = __nccwpck_require__(6746);
const bufferStream = __nccwpck_require__(8901);
...
var _signals=__nccwpck_require__(2543);
var _realtime=__nccwpck_require__(6988);
...
var _core=__nccwpck_require__(2503);
var _realtime=__nccwpck_require__(6988);
...
if (process.platform === 'win32' || global.TESTING_WINDOWS) {
  core = __nccwpck_require__(7870)
} else {
  core = __nccwpck_require__(8358)
}
...
const path = __nccwpck_require__(1017);
const pathKey = __nccwpck_require__(7458);
...
const mimicFn = __nccwpck_require__(9257);
...
var once = __nccwpck_require__(4917)
var eos = __nccwpck_require__(6804)
...
if (!processOk(process)) {
  ...
  var signals = __nccwpck_require__(1669)
...
const execa = __nccwpck_require__(5125)
